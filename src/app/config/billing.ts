...
import type { PlanEntitlement } from "@/shared/api";

// Feature codes — these are the map keys in PlanEntitlement.features (snake_case, matches YAML)
...
export const DEFAULT_PERSONAL_WORKSPACE_FEATURES: PlanEntitlement = {
  maxUsers: 1,
...
export const DEFAULT_FREE_TENANT_ENTITLEMENT: PlanEntitlement = {
  maxUsers: 1,
  maxProjects: 1,
  features: {},
};
