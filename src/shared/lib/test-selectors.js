...
export const TestSelectors = {
  ...
  // Navigation
  APP_NAV: "app-nav",
  NAV_ITEM: (name) => `nav-item--${name}`,
  NAV_SUBMENU: (name) => `nav-submenu--${name}`,
  // Common UI Elements
  ...
  SIGN_IN_TENANT_PICKER_TENANT: (tenantKey) => `tenant-picker-${tenantKey}`,
  ...
  // Signup Additional
  PASSWORD_STRENGTH: (testId) => testId,
  PASSWORD_STRENGTH_PROGRESS: (testId) => `${testId}-progress`,
  PASSWORD_STRENGTH_REQ: (testId, index) => `${testId}-req-${index}`,
  ...
  PROVISIONING_WAIT_STEP: (index) => `provisioning-wait-step-${index}`,
  ...
  PLAN_CARD: (planCode) => `plan-card-${planCode}`,
  PLAN_CARD_CURRENT_BADGE: (planCode) => `plan-card-${planCode}-current-badge`,
  PLAN_CARD_FEATURE: (planCode, index) => `plan-card-${planCode}-feature-${index}`,
  PLAN_CARD_BUTTON: (planCode) => `plan-card-${planCode}-button`,
  ...
  REFUND_LIST_ROW: (refundId) => `refund-list-row-${refundId}`,
  REFUND_LIST_ROW_DATE: (refundId) => `refund-list-row-${refundId}-date`,
  REFUND_LIST_ROW_AMOUNT: (refundId) => `refund-list-row-${refundId}-amount`,
  REFUND_LIST_ROW_STATUS_BADGE: (refundId) => `refund-list-row-${refundId}-status-badge`,
  REFUND_LIST_ROW_PAYMENT_ID: (refundId) => `refund-list-row-${refundId}-payment-id`,
  // Organization
  ...
  TENANT_SWITCHER_OPTION: (tenantKey) => `tenant-switcher-option-${tenantKey}`,
  ...
  GENERAL_SETTINGS_ORGANIZATION_ITEM: (orgName) => `general-settings-organization-item-${orgName}`,
  // Security Settings
  SECURITY_SETTINGS_PAGE: "security-settings-page",
  SECURITY_SETTINGS_ROLES_SECTION: "security-settings-roles-section",
  SECURITY_SETTINGS_ROLE_ITEM: (role) => `security-settings-role-item-${role}`,
  ...
  CMS_PAGE_ACTIONS_MENU_TRIGGER: (pageId) => `cms-page-${pageId}-actions-menu-trigger`,
  CMS_PAGE_EDIT_BUTTON: (pageId) => `cms-page-${pageId}-edit-button`,
  CMS_PAGE_DELETE_BUTTON: (pageId) => `cms-page-${pageId}-delete-button`,
  ...
  CMS_PAGE_EDIT: (pageId) => `cms-pages-edit-page-${pageId}`,
